...
def _render_subscription_page(config: Config, upstream: dict) -> str:
    ...
    purchased_volume = f"{config.volume_gb} گیگابایت" if config.volume_gb else "نامشخص"
    quick_connect = ""
